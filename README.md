...
Визуализация алгоритма поиска компонентов сильной связности в орграфе(и их итоговое расположение):


![strongly_connectivity_components (1)](https://github.com/user-attachments/assets/335d6c25-5c11-466b-86d2-f4db34b623be)
...
где вершина 6 — компонента сильной связности, в которую входили вершины 5, 6, 7, 8, 9, 10
